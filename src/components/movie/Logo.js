...
export default function Logo() {
	return (
		<div style={{ width: "200px", margin: "0 auto", paddingTop: "1rem" }}>
			<a href="/">
				<svg width="100%" height="100%" viewBox="0 0 369.7695137611495 99.39748629370771" className="css-1j8o68f">
					<defs id="SvgjsDefs1425"></defs>
					<g
						id="SvgjsG1426"
						featurekey="hmhgWD-0"
						transform="matrix(1.109547529249206,0,0,1.109547529249206,-8.307540521544272,-3.7305152954953327)"
						fill="#ff471f">
						<rect
